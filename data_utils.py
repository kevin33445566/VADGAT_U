...
from transformers import BertTokenizer, RobertaTokenizer, GPT2Tokenizer, AlbertTokenizer, BartTokenizer, XLMRobertaTokenizer, AutoTokenizer, DebertaTokenizer
    ...
    if os.path.exists(dat_fname):
        ...
        for fname in fnames:
            ...
            for i in range(0, len(lines), 3):
                ...
                text_raw = text_left + " " + aspect + " " + text_right+"the " +"target "+"aspect " +"is " + aspect
                text += text_raw + " "
...
def build_embedding_matrix(word2idx, embed_dim, dat_fname):
    if os.path.exists(dat_fname):
        ...
        fname = './glove.twitter.27B/glove.twitter.27B.200d.txt' \
    ...
    def __init__(self, fname, tokenizer):
        ...
        for i in range(0, len(lines), 3):
            ...
            concat_bert_indices = tokenizer.text_to_sequence(
                '<s> ' + text_left + " " + aspect + " " + text_right +' </s>')
            ...
            dependency_graph_o = np.pad(idx2graph_o[i], (
            (0, tokenizer.max_seq_len - idx2graph_o[i].shape[0]), (0, tokenizer.max_seq_len - idx2graph_o[i].shape[0])),
                                      'constant')
            ...
            data = {
                ...
                'dependency_graph_o': dependency_graph_o,
                'polarity': polarity,
            }
